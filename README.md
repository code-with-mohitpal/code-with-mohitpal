...
* 👋 Hi, I'm **Mohit Pal**
* 🎓 B.Tech CSE (AI & ML) Student @ Lovely Professional University
...
![XGBoost](https://img.shields.io/badge/XGBoost-EB0029?style=for-the-badge)
...
* 🤖 AI-powered healthcare assistant with real-time patient interaction
* 🧠 NLP + Machine Learning based system
* ⚙️ Flask backend + responsive frontend
* Team: Afreen Nisha, Mohit Pal, Prateek Pal
...
`Python` `Flask` `HTML` `CSS` `AI`

---

## 🔢 Number Guessing Games
* Python version with JSON-based persistence; Java version with flat-file storage
* A separate Java 17 / Swing / MySQL / JDBC version with login and game-history tracking

`Python` `Java` `Swing` `MySQL` `JDBC`

---

## 📝 Text Summarizer
* NLP-based intelligent summarizer converting long text into concise summaries
* Built using Transformers & Scikit-learn
...
* Fully responsive restaurant site with modern UI
...
* Automated street lighting project (embedded/IoT concept)
...
🔗 LeetCode Profile: https://leetcode.com/code-with-mohitpal/
...
<a href="https://linkedin.com/in/mohit-pal-274b36321">
